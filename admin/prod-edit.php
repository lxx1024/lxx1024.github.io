        ...
        <div class="product">
                ...
                <div class="wrapper">
                        <div class="fl">
                          ...
                          <div class="fr">
                                    <a href="prod-del.php?id=<?php echo "$row[0]" ?>" onclick="return confirm('确定删除该商品吗?');"  class="prod-del">
                ...
                <form action="prod-edit-action.php?id=<?php echo $prodId ?>" method="post" enctype="multipart/form-data">
                         <ul class="prod-details clearfix">
                                ...
                                <li>
                                        ...
                                        <div class="content fl">
                                                 <input class="submit" type="submit" value="确定修改"  onclick="return confirm('确定修改该商品分类信息?');">
                                        </div>
                                </li>
                         </ul>
                </form>
