...
<div class="topic w clearfix">
                ...
                <li class="topic-hot">
                 <!-- 从数据库提取手机社区对应的数据PHP代码 -->
                            <?php
                                ...
                                $q = "SELECT * FROM topic where type=0";                   //SQL查询语句 -----在此处改表名
                                // type 为0 代表是热点话题
    ...
    <div class="topic-right fr">
      ...
      <?php
                                include "../conn/conn.php";       //导入连接数据库php代码
                                $id = $_SESSION["userId"];
                                $q = "SELECT * FROM topic where userId='".$id."';";                   //SQL查询语句 -----在此处改表名
                                // type 为0 代表是热点话题
                                $result = mysql_query($q, $conn);                     //执行sql查询,
              ?>
        <div class="person">
                    ...
                    ?>
                        ...
                        <i class="number">已发布 <b> 9 </b> 条帖子</i>
                    </a>
                    <ul class="topics">
                    <?php
                            while ($row=mysql_fetch_row($result)){
